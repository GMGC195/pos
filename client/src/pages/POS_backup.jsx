...
<body>
  ...
  <div class="center footer">
    ...
    <p style="margin-top:6px;">ðŸ“ž ${BRAND_PHONE_DISPLAY}</p>
  </div>
  <div class="dotted"></div>
    ...
    <>
              ...
              : cart.map(item => (
                <div key={item.cartId} className="cart-item">
                  ...
                  <div className="qty-controls">
                    <button className="qty-btn" onClick={() => updateQty(item.cartId, -1)}>âˆ’</button>
                  ...
                  <button className="remove-btn" onClick={() => updateQty(item.cartId, -item.qty)}>âœ•</button>
                </div>
              ))
            }
            {cart.length > 0 && (
      ...
      <div className="receipt-section" ref={receiptRef} style={{ width: '80mm', padding: '2px 10px 6px 15px' }}>
        ...
        <div className="receipt-footer">
          ...
          <p>Come back soon ðŸ•</p>
          <p>{BRAND_RECEIPT_FOOTER}</p>
          <p style={{ marginTop: 6, fontSize: 11 }}>ðŸ“ž {BRAND_PHONE_DISPLAY}</p>
          ...
          <div className="modal-overlay" onClick={e => { if (e.target.classList.contains('modal-overlay')) setSizeModalItem(null) }}>
            <div className="modal" style={{ maxWidth: 440, padding: 24 }}>
              <div className="modal-header" style={{ marginBottom: 16 }}>
                ...
                <button className="modal-close" onClick={() => setSizeModalItem(null)}>âœ•</button>
              </div>
          ...
          <div className="modal-overlay" onClick={e => { if (e.target.classList.contains('modal-overlay')) setConfirmModal(false) }}>
            <div className="modal" style={{ maxWidth: 700, width: "90%", padding: 20 }}>
              <div className="modal-header">
                <h3>Confirm Order</h3>
                <button className="modal-close" onClick={() => setConfirmModal(false)}>âœ•</button>
              </div>
