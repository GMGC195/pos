...
<body>
  ...
  <div style="text-align: left; font-size: 11px;">
    ...
    ${order.customer_address ? `<p style="margin: 2px 0;"><strong>Address:</strong> ${order.customer_address}</p>` : ''}
  </div>
  ` : ''}
  <div class="divider"></div>
  ...
  return (
    <div className="modal-overlay" onClick={e => { if (e.target.classList.contains('modal-overlay')) onClose() }}>
      <div className="modal" style={{ maxWidth: 400, padding: 0, overflow: 'hidden' }}>
        <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--surface-2)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'white' }}>
        ...
        <div style={{ padding: 20, maxHeight: '70vh', overflowY: 'auto', background: '#fcfcfc' }}>
          ...
          <div style={{ background: 'white', padding: '2px 20px 6px 5px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', fontFamily: 'monospace', color: '#333', fontSize: 13, width: '70mm', margin: '0 auto' }}>
            ...
            {(order.customer_name || order.customer_phone || order.customer_address) && (
              <div style={{ marginBottom: 15, borderTop: '1px dashed #ddd', paddingTop: 12 }}>
                ...
                {order.customer_address && <p style={{ margin: '2px 0' }}><b>Address:</b> {order.customer_address}</p>}
              </div>
            )}
        ...
        <div style={{ padding: '16px 20px', borderTop: '1px solid var(--surface-2)', display: 'flex', gap: 10, background: 'white' }}>
